...
double GaussianQuad_N2(const double x1, const double x2)
{
    ...
    for (int i = 1; i <= 3; i++) {
        double z = (i == 1) ? 0.909632 : (i == 2) ? 0.540641 : 0.0;
        double z1, pp, p1, p2, p3;
        do {
            p1 = ((3.0 * z * z) - 1) / 2;
            p2 = z;
            p3 = 1;
...
int scanhash_m7m_hash(int thr_id,
                      uint32_t *pdata,
                      ...
                      unsigned long *hashes_done)
{
    ...
    mpf_set_str(mpt2,
                "0.8e3b1a9b359805c2e54c6415037f2e336893b6457f7754f6b4ae045eb6c5f2bedb26a114030846be7",
                16);
    mpf_set_str(magifpi0,
                "0.b7bfc6837e20bdb22653f1fc419f6bc33ca80eb65b7b0246f7f3b65689560aea1a2f2fd95f254d68c",
                16);
    ...
    do {
        ...
        sph_sha256_close(&ctx_final_sha256, hash);
        ...
        for (i = 0; i < 5; i++) {
            ...
            mpz_import(bns0, b, -1, p, -1, 0, hash);
            mpz_add(bns1, bns1, bns0);
            mpz_mul(product, product, bsn1);
